(function() {
  ...
  container.innerHTML = `
    <div class="form-group">
      ...
      <textarea id="hash-input" rows="5" placeholder="Enter string here..."></textarea>
    </div>
    
    <div class="result-area mb-4">
      <label class="font-bold block mb-2">MD5 Hash Result:</label>
      <pre id="hash-result" style="font-size: 1.25rem; word-break: break-all; min-height: 1.5rem;"></pre>
  ...
  input.addEventListener('input', () => {
    result.textContent = md5(input.value);
  });
